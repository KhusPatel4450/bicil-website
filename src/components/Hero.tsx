    ...
    >
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl mx-auto pt-16">
        ...
        <motion.h1
          ...
          className="text-5xl sm:text-6xl lg:text-[5.5rem] font-bold text-slate-900 leading-[1.05] mb-5 tracking-tight"
        >
          Bio-Inspired
          <br />
        ...
        <motion.p
          ...
          className="text-slate-600 text-lg sm:text-xl mb-11 max-w-2xl mx-auto leading-relaxed font-sans"
        >
        ...
        >
          <a
            href="#research"
            className="w-full sm:w-auto px-8 py-3.5 bg-[#2A7FC1] hover:bg-[#1B6BA8] text-white font-semibold text-sm transition-all duration-200 hover:shadow-xl hover:shadow-blue-900/20 hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4BBFCF]"
          >
            Explore Research
          </a>
          <a
            href="#team"
            className="w-full sm:w-auto px-8 py-3.5 border border-slate-300 hover:border-slate-500 text-slate-600 hover:text-slate-900 hover:bg-black/5 font-medium text-sm transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4BBFCF]"
          >
            Meet the Team
          </a>
        </motion.div>
